            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row md:items-baseline gap-4 md:gap-8">
                  ...
                  <p className="text-text-secondary font-medium text-sm md:text-base border-l-2 border-action/20 pl-6 italic max-w-sm">
                    Gere questões ENADE de alta qualidade em segundos — Garantia de especialista.
                  </p>
                </div>
              </div>
              ...
              <AnimatePresence>
                {question && (
                  <motion.div
                    ...
                    className="space-y-8"
                  >
                    <div className="bg-white rounded-card border border-[#E5E2DD] overflow-hidden shadow-sm shadow-black/5 print:border-none print:shadow-none">
                      {/* Meta Rail */}
                      <div className="flex items-center justify-between p-6 border-b border-[#F5F2ED] print:border-action">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex items-center gap-1 text-[9px] font-bold text-highlight bg-highlight/5 px-2 py-0.5 rounded-md print:hidden">
                        ...
                        <div className="flex gap-2 print:hidden">
                           ...
                           <button 
                            onClick={handleCopy} 
                            className="p-2 hover:bg-canvas rounded-ui transition-colors text-text-secondary hover:text-action"
                            title="Copiar texto"
                           >
                           ...
                           <button 
                            onClick={() => {
                              setShowAnswer(true);
                              // Garante que o estado de resposta aberta seja renderizado antes da impressão
                              setTimeout(() => {
                                window.print();
                              }, 300);
                            }} 
                        ...
                        <div className="print:block">
                          {!showAnswer ? (
                             <button 
                               ...
                               className="w-full py-6 rounded-ui bg-action text-white font-bold uppercase tracking-widest text-xs hover:brightness-110 transition-all print:hidden shadow-lg shadow-action/10"
                             >
                              Revelar Parecer Técnico e Gabarito
                             </button>
                          ) : (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8 pt-12 border-t border-[#F5F2ED] print:border-action">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 print:hidden">
                       {question.studySuggestions.map((s, i) => (
                         <div key={i} className="bg-white p-8 rounded-[32px] border border-[#E5E2DD] space-y-4 hover:shadow-lg transition-all">
                            ...
                            <p className="text-xs text-[#666] leading-relaxed">{s.description}</p>
                            <div className="flex flex-wrap gap-1">
                               {s.resources.map((r, ri) => (
                                 <span key={ri} className="px-2 py-0.5 bg-[#F5F2ED] text-[9px] font-bold text-[#999] rounded-md">{r}</span>
                               ))}
                            </div>
                         </div>
                       ))}
